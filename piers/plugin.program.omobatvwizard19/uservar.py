...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR limegreen][B]OmobaTV[/B][/COLOR] Wizard'
BUILDERNAME = 'OmobaTV'
EXCLUDES = [ADDON_ID, 'repository.Ardavetv']
# Text File with build info in it.
BUILDFILE = 'https://raw.githubusercontent.com/naijaping/awonlist/master/wizard/autobuild.txt'
...
THEME1 = '[COLOR '+COLOR1+'][[COLOR '+COLOR2+']+[/COLOR]][/COLOR] [COLOR '+COLOR2+']{0}[/COLOR]'
...
HIDECONTACT = 'No'
# You can add \n to do line breaks
CONTACT = 'Thank you for choosing OmobaTV Wizard.\n\nContact us on Github at '
...
NOTIFICATION = 'https://raw.githubusercontent.com/naijaping/awonlist/master/wizard/notify.txt'
# Use either 'Text' or 'Image'
HEADERTYPE = 'Text'
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR limegreen][B]OmobaTV[/B][/COLOR] Wizard'

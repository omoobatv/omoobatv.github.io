...
class navigator:
        ...
        NEWSFILE      = 'https://pastebin.com/raw/SRJZRQzE'
	    ...
	    if downloads == True:
	        self.addDirectoryItem(32009, 'downloadNavigator', 'business.jpg', 'DefaultFolder.jpg')
            self.addDirectoryItem('Scraper Settings', 'openscrapersSettings&query=0.0', 'tools.jpg', 'DefaultAddonProgram.png')
            self.addDirectoryItem(32010, 'searchNavigator', 'search.jpg', 'DefaultFolder.jpg')
            self.addDirectoryItem('Info!!!', 'newsNavigator', 'tools.jpg', 'DefaultAddonProgram.png')
 	    self.endDirectory()
...
#######################################################################
	...
	def wtf(self, lite=False):
            	self.addDirectoryItem('TMDb Info', 'openmeta_menu', 'tmdb.png', 'DefaultTVShows.jpg')
		...
		self.addDirectoryItem(32002, 'wtfShows', 'tvshows.jpg', 'DefaultTVShows.jpg')
	        self.addDirectoryItem('Swift Streams', 'swiftNavigator', 'networks.jpg', '')
                self.addDirectoryItem('SportPlugins', 'sportplugins', 'networks.jpg', 'fanart.jpg')       
            	self.addDirectoryItem('1Click Movie', 'oneclick', 'networks.jpg', 'DefaultRecentlyAddedMovies.png')   
	        self.addDirectoryItem('IPTV Channels', 'iptvNavigator', 'networks.jpg', 'fanart.jpg') 
		self.endDirectory()		
	...
	def critterLists(self):
        ...
        def iptv(self):
                self.addDirectoryItem('AllTV', 'alltv', 'networks.jpg', 'fanart.jpg')
                self.addDirectoryItem('CinemaTV', 'cinematv', 'networks.jpg', 'fanart.jpg')
	        self.addDirectoryItem('FaithTV', 'faithtv', 'networks.jpg', '')
	        self.addDirectoryItem('LodgeTV', 'lodgetv', 'networks.jpg', '')
	        self.addDirectoryItem('MyTV',  'mytv',  'networks.jpg',  'DefaultTVShows.png')
	        self.addDirectoryItem('RadioTV', 'radiotv', 'networks.jpg', '')
	        self.endDirectory()

	def oneclickmovies(self):
    		self.addDirectoryItem('1click', '1click', 'debrid.png', 'debrid.png')  
        	self.addDirectoryItem('1kmovies', '1kmovies', '1k.jpg', 'DefaultMovies.png')
        	self.addDirectoryItem('dtsmovies', 'dtsmovies', 'dts.jpg', 'debrid.png')  
        	self.addDirectoryItem('4kmovies', '4kmovies', '4k.jpeg', 'DefaultMovies.png')
        	self.addDirectoryItem('vipclick', 'vipclick', 'vip.png', 'DefaultMovies.png')
        	self.addDirectoryItem('nlmovie', 'nlmovie', 'dutch.png', 'debrid.png')  
        	self.addDirectoryItem('nltvshow', 'nltvshow', 'dutch.png', 'debrid.png')  
	...
	def tools(self):
		...
		self.addDirectoryItem(32052, 'clearCache', 'tools.jpg', 'DefaultAddonProgram.jpg')
        	self.addDirectoryItem(32361, 'authTrakt', 'tools.jpg', 'DefaultAddonProgram.png')

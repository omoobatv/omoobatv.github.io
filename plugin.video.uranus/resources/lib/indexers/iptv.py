...
class indexer:
    ...
    def root(self):
        try:
            regex.clear()
            url = '68747470733A2F2F7261772E67697468756275736572636F6E74656E742E636F6D2F64656D6F6E2D6269742F786D6C2D6D61737465722F6D61737465722F6C697374732F316D656E752E786D6C'.decode('hex')
    ...
    def rootalltv(self):
        try:
            regex.clear()
            url = '68747470733A2F2F7261772E67697468756275736572636F6E74656E742E636F6D2F64656D6F6E2D6269742F786D6C2D6D61737465722F6D61737465722F6C697374732F497074762F416C6C5054562E786D6C'.decode('hex')
            self.list = self.noname_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def rootfaithtv(self):
        try:
            regex.clear()
            url = '68747470733A2F2F7261772E67697468756275736572636F6E74656E742E636F6D2F64656D6F6E2D6269742F786D6C2D6D61737465722F6D61737465722F6C697374732F497074762F4661697468495054562E786D6C'.decode('hex')
            self.list = self.noname_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def rootlodgetv(self):
        try:
            regex.clear()
            url = '68747470733A2F2F7261772E67697468756275736572636F6E74656E742E636F6D2F64656D6F6E2D6269742F786D6C2D6D61737465722F6D61737465722F6C697374732F497074762F4C6F646765495054562E786D6C'.decode('hex')
            self.list = self.noname_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def rootradiotv(self):
        try:
            regex.clear()
            url = '68747470733A2F2F7261772E67697468756275736572636F6E74656E742E636F6D2F64656D6F6E2D6269742F786D6C2D6D61737465722F6D61737465722F6C697374732F497074762F526164696F495054562E786D6C'.decode('hex')
            self.list = self.noname_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def rootsportplugins(self):
        try:
            regex.clear()
            url = '68747470733A2F2F7261772E67697468756275736572636F6E74656E742E636F6D2F64656D6F6E2D6269742F786D6C2D6D61737465722F6D61737465722F6C697374732F497074762F53706F7274506C7567696E732E786D6C'.decode('hex')
            self.list = self.noname_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def rootmytv(self):
        try:
            regex.clear()
            url = '68747470733A2F2F7261772E67697468756275736572636F6E74656E742E636F6D2F64656D6F6E2D6269742F786D6C2D6D61737465722F6D61737465722F6C697374732F497074762F4D79497074762E786D6C'.decode('hex')
            self.list = self.noname_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def rootdtsmovies(self):
        try:
            regex.clear()
            url = '68747470733A2F2F7261772E67697468756275736572636F6E74656E742E636F6D2F64656D6F6E2D6269742F786D6C2D6D61737465722F6D61737465722F6D6F766965732F6474732E786D6C'.decode('hex')
            self.list = self.noname_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def rootXXX(self):
        try:
            regex.clear()
            url = '68747470733A2F2F7261772E67697468756275736572636F6E74656E742E636F6D2F64656D6F6E2D6269742F786D6C2D6D61737465722F6D61737465722F6C697374732F6164756C742E6D3375'.decode('hex')
            self.list = self.noname_list(url)
            for i in self.list:
    ...
    def root_1click(self): # Real Debrid
        try:
            ...
            pass 
# 687474703A2F2F6C757875727977697A6172642E73706163652F786D6C732F72642F72646D6F766965732F616C6C2E72642E786D6C
# 687474703A2F2F6C757875727977697A6172642E73706163652F786D6C732F72642F72646D6F766965732F616C6C2E72642E7067322E786D6C

    def rootnlmovie(self):
        try:
            regex.clear()
            url = '68747470733A2F2F7261772E67697468756275736572636F6E74656E742E636F6D2F64656D6F6E2D6269742F786D6C2D6D61737465722F6D61737465722F6D6F766965732F6E6C6D6F7669652E786D6C'.decode('hex')
            self.list = self.noname_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def rootnltvshow(self):
        try:
            regex.clear()
            url = '68747470733A2F2F7261772E67697468756275736572636F6E74656E742E636F6D2F64656D6F6E2D6269742F786D6C2D6D61737465722F6D61737465722F6D6F766965732F6E6C747673686F772E786D6C'.decode('hex')
            self.list = self.noname_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def rootvipclick(self):
        try:
            regex.clear()
            url = '68747470733A2F2F7261772E67697468756275736572636F6E74656E742E636F6D2F64656D6F6E2D6269742F786D6C2D6D61737465722F6D61737465722F6D6F766965732F7669706D6F766965732E786D6C'.decode('hex')
            self.list = self.noname_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def rootopenmeta_menu(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/demon-bit/xml-master/master/lists/openmeta_menu.xml'
            self.list = self.noname_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
